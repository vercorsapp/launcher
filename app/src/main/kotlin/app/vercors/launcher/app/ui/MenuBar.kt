...
import app.vercors.launcher.core.presentation.ui.clickableButton
import app.vercors.launcher.core.presentation.ui.clickableIcon
    ...
    Row(
        ...
        Row(
            ...
            Icon(
                ...
                tint = if (canGoBack) MaterialTheme.colorScheme.onSurface else MaterialTheme.colorScheme.surfaceBright,
